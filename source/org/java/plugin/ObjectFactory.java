...
public abstract class ObjectFactory
{
	 ...
	 * <ul>
	 * <li>Use the <code>org.java.plugin.ObjectFactory</code> property from the
	 * given properties collection (if it is provided).</li>
	 * <li>Use the <code>org.java.plugin.ObjectFactory</code> system property.</li>
