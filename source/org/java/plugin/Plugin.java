...
/**
 * This is base for "home" class of plug-in runtime. Using this class, plug-in
 * code can get access to plug-in framework (
 * {@link org.java.plugin.PluginManager manager},
 * {@link org.java.plugin.registry.PluginRegistry registry}) which was loaded
 * it. It is also used by manager during plug-in life cycle management
