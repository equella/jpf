...
public abstract class PluginManager
{
	 ...
	 */
	public static final String VERSION_PROPERTY = "org.java.plugin.jpf-version"; //$NON-NLS-1$
	 ...
	 */
	public abstract Map<String, Identity> publishPlugins(final PluginLocation[] locations)
		throws JpfException;
	 ...
	 */
	public abstract Plugin getPlugin(final String id) throws PluginLifecycleException;
	 ...
	 * @throws PluginLifecycleException if plug-in can't be found or activated
	 */
	public abstract void activatePlugin(final String id) throws PluginLifecycleException;
	 ...
	 */
	public abstract PluginClassLoader getPluginClassLoader(final PluginDescriptor descr);
	 ...
	 */
	public abstract PluginDescriptor[] disablePlugin(final PluginDescriptor descr);
	 ...
	 * @param includeDependings if <code>true</code>, depending plug-ins will be
	 *            also enabled
	 * @return descriptors of plug-ins that was actually enabled
	 * @see #disablePlugin(PluginDescriptor)
	 */
	public abstract PluginDescriptor[] enablePlugin(final PluginDescriptor descr,
	 ...
	 * @param descr plug-in descriptor
	 */
	protected final void initPlugin(final Plugin plugin, final PluginDescriptor descr)
	{
