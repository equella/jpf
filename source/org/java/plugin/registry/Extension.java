...
/**
 * This interface abstracts an extension - particular functionality, the plug-in
...
public interface Extension extends UniqueIdentity, PluginElement<Extension>
{
	...
	interface Parameter extends PluginElement<Parameter>
	{
		...
		/**
		 * Returns definition for this extension parameter. May return
		 * <code>null</code> for "invalid" parameters.
		 * 
		 ...
		 * is not of type {@link ParameterType#STRING}, this method should throw
		...
		/**
		 * Returns "typed" value of parameter. If this parameter is invalid or
		 * is not of type {@link ParameterType#BOOLEAN}, this method should
		...
		/**
		 * Returns "typed" value of parameter. If this parameter is invalid or
		 * is not of type {@link ParameterType#NUMBER}, this method should throw
		 * an {@link UnsupportedOperationException}.
		 * 
		...
		/**
		 * Returns "typed" value of parameter. If this parameter is invalid or
		 * is not of type {@link ParameterType#PLUGIN_ID}, this method should
		 * throw an {@link UnsupportedOperationException}.
		 * 
		...
		/**
		 * Returns "typed" value of parameter. If this parameter is invalid or
		 * is not of type {@link ParameterType#EXTENSION_POINT_ID}, this method
		...
		/**
		 * Returns "typed" value of parameter. If this parameter is invalid or
		 * is not of type {@link ParameterType#EXTENSION_ID}, this method should
		 * throw an {@link UnsupportedOperationException}.
		 * 
		...
		/**
		 * Returns "typed" value of parameter. If this parameter is invalid or
		 * is not of type {@link ParameterType#RESOURCE}, this method should
		 * throw an {@link UnsupportedOperationException}.
		 * 
