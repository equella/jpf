...
public interface ExtensionPoint extends UniqueIdentity, PluginElement<ExtensionPoint>
{
	...
	/**
	 * Returns collection of all top level parameter definitions declared in
	 * this extension point and all it parents.
	 * 
	...
	/**
	 * Checks if extension is in valid state and successfully "connected" to
	 * this extension point. If this method returns <code>true</code>, the
	 * method {@link #getConnectedExtension(String)} should return valid
	 * extension for the same UID.
	 * 
	 * @param uniqueId unique ID of extension
	...
	/**
	 * Looks for all available (valid) successors of this extension point. The
	 * search should be done recursively including all descendants of this
	 * extension point.
	 * 
	...
	{
		/**
		 * @return multiplicity of parameter, that can be defined according to
		 *         this definition
		 */
		ParameterMultiplicity getMultiplicity();

		/**
		 * @return value type of parameter, that can be defined according to
		 *         this definition
		 */
		...
		/**
		 * Returns collection of all parameter sub-definitions declared in this
