...
public interface Library extends UniqueIdentity, PluginElement<Library>
{
	 ...
	 * available to other plug-ins. <br>
	 * For code library, prefix is a package name, for resource library, the
	 * same rules applied to relative resource path calculated against library
	 * path (you can replace slash characters in path with dots). <br>
