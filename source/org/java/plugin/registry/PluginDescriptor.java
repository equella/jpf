...
/**
 * Main interface to get access to all meta-information for particular plug-in,
 * described in plug-in manifest file.
 * <p>
 * Plug-in UID is a combination of plug-in ID and version identifier that is
 * unique within whole set of registered plug-ins.
 * </p>
 * 
 * @see <a href="{@docRoot}/../plugin_1_0.dtd">plug-in DTD for standard registry
 *      implementation</a>
