 ...
 * by {@link #register(URL[]) registering} or {@link #unregister(String[])
 * un-registering} plug-ins with this registry. If your code is interested to be
 * notified on all modifications of plug-ins set, you can
...
public interface PluginRegistry
{
	 ...
	 * 
	 * @param ids ID's of plug-ins and plug-in fragments to be unregistered
	 ...
	 * <code>true</code>, the method {@link #getPluginDescriptor(String)} should
	 * always return valid plug-in descriptor.
	 * 
	 ...
	 *            registration report will be included into resulting report
	 * @return integrity check report
	 */
