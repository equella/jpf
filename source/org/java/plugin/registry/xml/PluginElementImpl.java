 ...
 * @version $Id$
 */
abstract class PluginElementImpl<T extends PluginElement<T>> extends IdentityImpl
	implements
		PluginElement<T>
{
	...
	protected PluginElementImpl(final PluginDescriptor descr, final PluginFragment aFragment,
		final String id, final ModelDocumentation modelDoc) throws ManifestProcessingException
	{
		super(id);
		descriptor = descr;
		fragment = aFragment;
