...
class PluginFragmentImpl extends IdentityImpl implements PluginFragment
{
	...
	PluginFragmentImpl(final PluginRegistry aRegistry, final ModelPluginFragment aModel)
		throws ManifestProcessingException
	{
		...
		{
			doc = new DocumentationImpl<PluginFragment>(this, model.getDocumentation());
		}
	...
	/**
	 * @see org.java.plugin.registry.PluginFragment#matches(org.java.plugin.registry.PluginDescriptor)
	 */
	public boolean matches(final PluginDescriptor descr)
	{
		return PluginPrerequisiteImpl.matches(model.getPluginVersion(), descr.getVersion(),
