...
public abstract class PluginLifecycleHandler
{
	 ...
	 * logic should be executed in new class instance during this method call. <br>
	 ...
	 */
	protected abstract void beforePluginStart(final Plugin plugin) throws PluginLifecycleException;
	 ...
	 */
	protected abstract void afterPluginStop(final Plugin plugin) throws PluginLifecycleException;
