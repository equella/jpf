...
public class StandardObjectFactory extends ObjectFactory
{
	...
	{
		config = (configuration != null) ? configuration : new ExtendedProperties();
	}
	...
	protected Object createClassInstance(final String className) throws InstantiationException,
	...
	/**
	 * @see org.java.plugin.ObjectFactory#createManager(org.java.plugin.registry.PluginRegistry,
