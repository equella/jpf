 ...
 * value is <code>false</code> that corresponds to standard delegation model for
 * classloaders hierarchy that corresponds to JLS.</dd>
 * <dt>stickySynchronizing</dt>
 * <dd>Allows advanced configuring of classloaders synchronization in
 * multy-threaded environment. If <code>true</code> then class loading will be
 * synchronized with initial plug-in classloader instance. Otherwise
 ...
 * <dd>If <code>true</code> then plug-in classloader will collect local packages
 * statistics to predict class location. This allow to optimize class look-up
 * procedure for classes that belong to the requested plug-in. Default value is
 * <code>true</code>.</dd>
 * <dt>foreignClassLoadingOptimization</dt>
 * <dd>If <code>true</code> then plug-in classloader will collect statistics for
 * "foreign" classes - those which belong to depending plug-ins. This allow to
...
public class StandardPluginLifecycleHandler extends PluginLifecycleHandler
{
	 ...
	 * 
	 * @see org.java.plugin.standard.PluginLifecycleHandler#createPluginClassLoader(org.java.plugin.registry.PluginDescriptor)
	 */
	@Override
	protected org.java.plugin.PluginClassLoader createPluginClassLoader(final PluginDescriptor descr)
	{
		...
		StandardPluginClassLoader result = AccessController
			.doPrivileged(new PrivilegedAction<StandardPluginClassLoader>()
			{
	 ...
	 * {@link PluginManager#getPluginClassLoader(PluginDescriptor) plug-in's
	 * class loader}.
	 * 
	 * @see org.java.plugin.standard.PluginLifecycleHandler#createPluginInstance(org.java.plugin.registry.PluginDescriptor)
	 */
	@Override
		...
		throws PluginLifecycleException
	{
		...
		{
			throw new PluginLifecycleException(StandardObjectFactory.PACKAGE_NAME,
	 ...
	 * 
	 * @see org.java.plugin.standard.PluginLifecycleHandler#beforePluginStart(org.java.plugin.Plugin)
	 */
	@Override
	 ...
	 * This method does nothing in this implementation.
	 * 
	 * @see org.java.plugin.standard.PluginLifecycleHandler#afterPluginStop(org.java.plugin.Plugin)
	 */
	@Override
	...
	/**
	 * @see org.java.plugin.standard.PluginLifecycleHandler#configure(ExtendedProperties)
	 */
	@Override
