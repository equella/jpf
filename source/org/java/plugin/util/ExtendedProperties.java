...
public class ExtendedProperties extends Properties
{
	...
	/**
	 * Any parameter like <code>${propertyName}</code> in property value will be
	 * replaced with the value of property with name <code>propertyName</code>.
	 * <p>
	 ...
	 * @return sub-properties
	 */
	public ExtendedProperties getSubset(final String prefix, final String newPrefix)
	{
